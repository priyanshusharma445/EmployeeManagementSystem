...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    AddEmployee() {
        ...
        setLayout(null);
          ...
          /*ImageIcon i1 = new ImageIcon("C://Users//User//Desktop//Employee123//pexels-mccutcheon-1209843.jpg");
	...
	add(image);*/
        ...
        JLabel labelphone = new JLabel("Content Number :");
        ...
        lblempId = new JLabel("" + number);//old concept :/string convert integer
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                Conn conn = new Conn();
                String query = "insert into Employee1 values('"+name+"', '"+fathername+"', '"+DOB+"', '"+salary+"', '"+address+"', '"+phone+"', '"+email+"', '"+education+"', '"+designation+"', '"+aadhar+"', '"+empId+"')";
